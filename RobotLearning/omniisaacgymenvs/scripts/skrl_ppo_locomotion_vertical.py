...
env = load_omniverse_isaacgym_env(task_name="QuadrupedPoseControlVertical")
env = wrap_env(env)
...
runs_dir = os.path.join(env_dir, "runs", "SKRL-QuadrupedPoseControlVertical")
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-OldOV-LocomotionVerticalTransferrable-Test",
...
checkpoint_dir = os.path.join(runs_root, "SKRL-QuadrupedManipulatePlateVertical", "0605-half_yaw-2000env", "checkpoints", "best_agent.pt")
