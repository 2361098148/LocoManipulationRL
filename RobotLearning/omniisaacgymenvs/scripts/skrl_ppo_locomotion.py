...
env = load_omniverse_isaacgym_env(task_name="QuadrupedPoseControl")
env = wrap_env(env)
...
runs_dir = os.path.join(env_dir, "runs", "SKRL-QuadrupedPoseControl")
cfg_ppo["experiment"]["directory"] = runs_dir
if eval:
    cfg_ppo["experiment"]["experiment_name"] = "test"
else:
    cfg_ppo["experiment"]["experiment_name"] = "0605-half_yaw-2000env-transfer"
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-OldOV-LocomotionTransferrable-Test",
...
checkpoint_dir = os.path.join(runs_root, "SKRL-QuadrupedManipulationPlate", "0605-half_yaw-2000env", "checkpoints", "best_agent.pt")
# checkpoint_dir = os.path.join(runs_dir, "0601-full_yaw-rand_init_pose_lower_action_acc", "checkpoints", "best_agent.pt")
# checkpoint_dir = os.path.join(runs_dir, "0601-full_yaw-positve_quat_diff_real", "checkpoints", "best_agent.pt")
