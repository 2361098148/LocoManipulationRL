...
env = load_omniverse_isaacgym_env(task_name="RealQuadrupedMotionReplay")
env = wrap_env(env)
...
cfg_ppo["experiment"]["write_interval"] = 300000

env_dir = os.path.dirname(os.path.dirname(__file__))
runs_dir = os.path.join(env_dir, "runs", "VelSinLoad")
cfg_ppo["experiment"]["directory"] = runs_dir
cfg_ppo["experiment"]["experiment_name"] = "test"
cfg_ppo["experiment"]["checkpoint_interval"] = 1200000
