...
env = load_omniverse_isaacgym_env(task_name="QuadrupedPoseControlCustomController")
env = wrap_env(env)
...
runs_dir = os.path.join(env_dir, "runs", "SKRL-QuadrupedPoseControlCustomController")
cfg_ppo["experiment"]["directory"] = runs_dir
if eval:
    cfg_ppo["experiment"]["experiment_name"] = "test"
else:
    cfg_ppo["experiment"]["experiment_name"] = "0526-1action_scale_rm_rot_dist_dec_rew"
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-OldOV-LocomotionCustomControllerTransferrable-Test",
...
checkpoint_dir = os.path.join(runs_dir, "0526-1action_scale_rm_rot_dist_dec_rew", "checkpoints", "best_agent.pt")
