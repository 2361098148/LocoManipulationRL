...
env = load_omniverse_isaacgym_env(task_name="QuadrupedManipulatePlate")
env = wrap_env(env)
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-OrebotOV-ManipulationTransferrable-Test",
...
checkpoint_dir = os.path.join(runs_root, "SKRL-QuadrupedPoseControl", "0605-half_yaw-2000env", "checkpoints", "best_agent.pt")
# checkpoint_dir = os.path.join(runs_dir, "0603-full_yaw-06roll_pitch", "checkpoints", "best_agent.pt")
