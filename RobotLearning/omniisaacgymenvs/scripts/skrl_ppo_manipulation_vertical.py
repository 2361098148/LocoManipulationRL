...
env = load_omniverse_isaacgym_env(task_name="QuadrupedManipulatePlateVertical")
env = wrap_env(env)
...
runs_dir = os.path.join(env_dir, "runs", "SKRL-QuadrupedManipulatePlateVertical")
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-OldOV-ManipulationVerticalTransferrable-Test",
...
checkpoint_dir = os.path.join(runs_root, "SKRL-QuadrupedPoseControlVertical", "0605-half_yaw-2000env", "checkpoints", "best_agent.pt")
# checkpoint_dir = os.path.join(runs_dir, "0521-half_yaw_low_precision2", "checkpoints", "best_agent.pt")
