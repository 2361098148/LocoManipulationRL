...
env = load_omniverse_isaacgym_env(task_name="JointLocomanipulation")
env = wrap_env(env)
...
runs_dir = os.path.join(env_dir, "runs", "SKRL-JointManipulation")
cfg_ppo["experiment"]["directory"] = runs_dir
if eval:
    cfg_ppo["experiment"]["experiment_name"] = "test"
else:
    cfg_ppo["experiment"]["experiment_name"] = "0605-half_yaw-2000env-old_init_pose"
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-JointLocomanipulation",
...
# checkpoint_dir = os.path.join(runs_root, "SKRL-QuadrupedPoseControl", "0605-half_yaw-2000env-transfer", "checkpoints", "best_agent.pt")
# checkpoint_dir = os.path.join(runs_root, "SKRL-QuadrupedManipulationPlate", "0605-half_yaw-2000env-transfer", "checkpoints", "best_agent.pt")
checkpoint_dir = os.path.join(runs_dir, "0605-half_yaw-2000env-old_init_pose", "checkpoints", "best_agent.pt")
