...
env = load_omniverse_isaacgym_env(task_name="QuadrupedManipulatePlatePositionControl")
env = wrap_env(env)
...
runs_dir = os.path.join(env_dir, "runs", "SKRL-QuadrupedManipulationPlate")
cfg_ppo["experiment"]["directory"] = runs_dir
if eval:
    cfg_ppo["experiment"]["experiment_name"] = "test"
else:
    cfg_ppo["experiment"]["experiment_name"] = "position_control-0604-05_roll_pitch"
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-OrebotOV-ManipulationPositionControl",
...
# checkpoint_dir = os.path.join(runs_root, "SKRL-QuadrupedPoseControlCustomController", "0526-1action_scale_rm_rot_dist_dec_rew", "checkpoints", "best_agent.pt")
checkpoint_dir = os.path.join(runs_dir, "position_control-0604-05_roll_pitch", "checkpoints", "best_agent.pt")
