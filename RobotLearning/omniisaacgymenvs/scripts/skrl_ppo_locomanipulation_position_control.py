...
env = load_omniverse_isaacgym_env(task_name="JointLocomanipulationPositionControl")
env = wrap_env(env)
...
if eval:
    ...
    cfg_ppo["experiment"]["experiment_name"] = "position_control-0604-test"
...
checkpoint_dir = os.path.join(runs_dir, "position_control-0604-test", "checkpoints", "best_agent.pt")
