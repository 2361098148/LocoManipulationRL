...
env = load_omniverse_isaacgym_env(task_name="JointLocomanipulationVertical")
env = wrap_env(env)
...
runs_dir = os.path.join(env_dir, "runs", "SKRL-JointLocomanipulationVertical")
cfg_ppo["experiment"]["directory"] = runs_dir
if eval:
    cfg_ppo["experiment"]["experiment_name"] = "test"
else:
    cfg_ppo["experiment"]["experiment_name"] = "0605-half_yaw-2000env"
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-JointLocomanipulationVertical",
...
# checkpoint_dir = os.path.join(runs_root, "SKRL-UnitedQuadrupedPoseControlOmni", "0515-test_skrl", "checkpoints", "best_agent.pt")
checkpoint_dir = os.path.join(runs_dir, "0605-half_yaw-2000env", "checkpoints", "best_agent.pt")
