...
env = load_omniverse_isaacgym_env(task_name="QuadrupedManipulatePlateCustomController")
env = wrap_env(env)
...
runs_dir = os.path.join(env_dir, "runs", "SKRL-QuadrupedManipulationPlateCustomController")
cfg_ppo["experiment"]["directory"] = runs_dir
if eval:
    cfg_ppo["experiment"]["experiment_name"] = "test"
else:
    cfg_ppo["experiment"]["experiment_name"] = "0526-test"
...
cfg_ppo["experiment"]["wandb_kwargs"] = {"project": "LocomanipulationRLExperiments",
                           ...
                           "group": "SKRL-OrebotOV-ManipulationCustomControllerTransferrable-Test",
...
checkpoint_dir = os.path.join(runs_dir, "0526-test", "checkpoints", "best_agent.pt")
