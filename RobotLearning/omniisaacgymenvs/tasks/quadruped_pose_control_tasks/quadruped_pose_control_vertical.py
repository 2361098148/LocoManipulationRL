...
from robot.quadruped_robot import QuadrupedRobotVerticalOVOmni
from tasks.base.rl_task import RLTask
...
class QuadrupedPoseControlVertical(RLTask):
    '''
    ...
    def __init__(self, sim_config, name, env, offset=None) -> None:
        ...
        self.default_pose_indicator_loco_positions = torch.tensor([[0.0, 0.0, 0.4]], dtype=torch.float32, device=self._device).repeat((self._num_envs, 1))
        # Metrics
