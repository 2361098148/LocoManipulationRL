...
class QuadrupedManipulatePlate(RLTask):
    '''
    ...
    def reset_idx(self, env_ids):
        ...
        # rand_obj_quaternions_robot = rand_quaternions(num_reset,
        #                                           0.0,
        #                                           0.0,
        #                                           0.0,
        #                                           0.0,
        ...
        #                                           max_yaw=np.pi/2,
        #                                           device=self._device)
        # rand_obj_quat_world = rotate_orientations(self.default_robot_quaternions_mani[env_ids], rand_obj_quaternions_robot, device=self._device)
